...
export interface StfCoreScorpioFargateProps {
    vpc: Vpc
...
export class StfCoreScorpioFargate extends Construct {
    public readonly fargate_alb : ApplicationLoadBalancedFargateService

    constructor(scope: Construct, id: string, props: StfCoreScorpioFargateProps) {
        super(scope, id)
