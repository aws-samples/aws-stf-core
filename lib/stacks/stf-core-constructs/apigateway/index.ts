...
export interface StfCoreApiGatewayProps {
    readonly vpc: Vpc,
    readonly fargate_alb: ApplicationLoadBalancedFargateService
}

export class StfCoreApiGateway extends Construct{
    public readonly api_ref: string
    constructor(scope: Construct, id: string, props: StfCoreApiGatewayProps) {
        super(scope, id)
        // Check props
        if (!props.vpc){
            throw new Error('The property vpc is required to create an instance of StfCoreApiGateway Construct')
        }
        if (!props.fargate_alb){
            throw new Error('The property fargate_alb is required to create an instance of StfCoreApiGateway Construct')
        }
