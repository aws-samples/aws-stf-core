...
export const Parameters = {
    ...
    stf_scorpio: {
        image_context_broker: 'public.ecr.aws/scorpiobroker/scorpio-aio:latest', // Like to ECR Public gallery of Scoprio Broker image.
        ...
        dabaseName: 'scorpio',
        aurora_serverless: false, // If false, this will create a RDS PostgreSQL Database instance.
        aurora_scaling: {
